                    ...
                    <div class="card-body custom-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <input type="number" class="form-control custom-input" name="old_price" placeholder="Old Price">
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <input type="number" class="form-control custom-input" name="new_price" placeholder="New Price">
